...
set_window_value(AT_JAB, 1, AG_WINDOW_SFX, asset_get("sfx_blow_weak1"));
...
set_window_value(AT_JAB, 4, AG_WINDOW_SFX, asset_get("sfx_blow_weak2"));
...
set_window_value(AT_JAB, 7, AG_WINDOW_SFX, asset_get("sfx_blow_heavy2"));

set_window_value(AT_JAB, 8, AG_WINDOW_LENGTH, 3);
set_window_value(AT_JAB, 8, AG_WINDOW_ANIM_FRAMES, 1);
set_window_value(AT_JAB, 8, AG_WINDOW_ANIM_FRAME_START, 2);
...
set_hitbox_value(AT_JAB, 3, HG_HEIGHT, 15);
set_hitbox_value(AT_JAB, 3, HG_ANGLE, 26);
set_hitbox_value(AT_JAB, 3, HG_BASE_KNOCKBACK, 3);
set_hitbox_value(AT_JAB, 3, HG_KNOCKBACK_SCALING, 1.4);
